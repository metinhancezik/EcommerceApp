        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderStateDescription = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuthTokens_UserDetails_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PasswordResets_UserDetails_UserId",
                        column: x => x.UserId,
                        principalTable: "UserDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAuths_UserDetails_UserId",
                        column: x => x.UserId,
                        principalTable: "UserDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_Vendors_VendorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderInformations_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderInformations_Cities_CityId1",
                        column: x => x.CityId1,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderInformations_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderInformations_Countries_CountryId1",
                        column: x => x.CountryId1,
                        principalTable: "Countries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderInformations_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderInformations_Districts_DistrictId1",
                        column: x => x.DistrictId1,
                        principalTable: "Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderInformations_Neighborhoods_NeighborhoodId",
                        column: x => x.NeighborhoodId,
                        principalTable: "Neighborhoods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderInformations_Neighborhoods_NeighborhoodId1",
                        column: x => x.NeighborhoodId1,
                        principalTable: "Neighborhoods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderInformations_UserDetails_UserId",
                        column: x => x.UserId,
                        principalTable: "UserDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHistories_OrderInformations_OrderInformationId",
                        column: x => x.OrderInformationId,
                        principalTable: "OrderInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderHistories_OrderStates_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_Vendors_VendorsId",
                        column: x => x.VendorsId,
                        principalTable: "Vendors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatuses_OrderInformations_OrderInformationId",
                        column: x => x.OrderInformationId,
                        principalTable: "OrderInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderStatuses_OrderStates_StateId",
                        column: x => x.StateId,
                        principalTable: "OrderStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHistories_OrderInformationId",
                table: "OrderHistories",
                column: "OrderInformationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderHistories_StateId",
                table: "OrderHistories",
                column: "StateId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_CityId",
                table: "OrderInformations",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_CityId1",
                table: "OrderInformations",
                column: "CityId1");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_CountryId",
                table: "OrderInformations",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_CountryId1",
                table: "OrderInformations",
                column: "CountryId1");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_DistrictId",
                table: "OrderInformations",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_DistrictId1",
                table: "OrderInformations",
                column: "DistrictId1");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_NeighborhoodId",
                table: "OrderInformations",
                column: "NeighborhoodId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_NeighborhoodId1",
                table: "OrderInformations",
                column: "NeighborhoodId1");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInformations_UserId",
                table: "OrderInformations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_VendorsId",
                table: "OrderItems",
                column: "VendorsId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuses_OrderInformationId",
                table: "OrderStatuses",
                column: "OrderInformationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuses_StateId",
                table: "OrderStatuses",
                column: "StateId");
